...
public class CommunityCardsStack extends CardsStack {
	...
	public CommunityCardsStack() {
		...
		pushOnTop(new CommunityCard(bundle.getString("comm_2"),
				bundle.getString("comm_2.1"), "move", false));
